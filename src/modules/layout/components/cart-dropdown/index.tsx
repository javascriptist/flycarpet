...
>
  ...
  {` (${totalItems})`}
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+1px)] right-0 w-[420px] text-ui-fg-base liquid-glass-popover rounded-2xl shadow-2xl"
            data-testid="nav-cart-dropdown"
          >
            <div className="p-4 flex items-center justify-center liquid-glass-header rounded-t-2xl">
              ...
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular border-t border-gray-100">
                  ...
                  <LocalizedClientLink href="/cart" passHref>
                    <Button
                      className="w-full rounded-3xl liquid-glass"
                      size="large"
